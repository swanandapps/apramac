...
<el-row id="checkout-row">
         <el-col :span="12">
          ...
          <p>Order Total : {{Math.round(form.total -form.total*code2/100)}} ₹ </p>
          <div id="order-summ-div" v-for="(product,index) in cartproducts" :key="index">
          <img :alt="cartproducts[index].name" id="order-summ-img" onContextMenu="return false;" :src="cartproducts[index].image">
 <div id="productdata">
...
<el-radio-group style="color:black" v-model="form.radios" :mandatory="false">
      ...
      <el-radio style="margin-left:0" label="Online Payment" value="Online Payment (Prepaid)"></el-radio>
    </el-radio-group>
    </el-form-item>
...
let orderdata={
 firstname: tempthis.form.firstname,
          ...
          week:tempthis.form.week,
           Coupon:tempthis.$store.state.promo_applied,
           paintings:tempthis.form.contains_paintings,
           homedecor:tempthis.form.contains_homedecor,
           pottery:tempthis.form.contains_pottery,
           sculpture:tempthis.form.contains_sculpture,
           order_status:true
